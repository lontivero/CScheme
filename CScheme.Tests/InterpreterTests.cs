...
public class InterpreterTests
{
    ...
    [InlineData("(if (zero? (* 0 1)) 10 20)", "10" , "if")]
    [InlineData("(if (zero? (* 1 1)) 10 20)", "20" , "if")]
    [InlineData("(if (zero? (* 1 1)) 10 bomb)", "10" , "if (special form)")]
    ...
    [InlineData("(let ((a 00) (b 10) (c 20)) (if (zero? a) c b))", "20" , "conditional eval")]
    ...
    [InlineData("(and 0 0)", "#f" , "or (false)")]
    [InlineData("(and 1 0)", "#f" , "or (false)")]
    [InlineData("(and 0 1)", "#f" , "or (false)")]
    [InlineData("(and 1 1)", "#t" , "or (true)")]
    [InlineData("(or 0 0)", "#f" , "or (false)")]
    [InlineData("(or 1 0)", "#t" , "or (true)")]
    [InlineData("(or 0 1)", "#t" , "or (true)")]
    [InlineData("(or 1 1)", "#t" , "or (true)")]
    [InlineData("(not? 0)", "#t" , "or (true)")]
    [InlineData("(not? 1)", "#f" , "or (false)")]
    [InlineData("(xor 0 0)", "#f" , "xor (false)")]
    [InlineData("(xor 1 0)", "#t" , "xor (true)")]
    [InlineData("(xor 0 1)", "#t" , "xor (true)")]
    [InlineData("(xor 1 1)", "#f" , "xor (false)")]
